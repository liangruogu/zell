...
export function PptToolbar() {
  ...
  const add = (type: CanvasElement['type']) => {
    ...
    const defaults: Record<string, Partial<CanvasElement>> = {
      text: { type: 'text', x: 100, y: 100, w: 200, h: 30, opacity: 1, props: { text: '新文本', fontSize: 20, fontColor: '#333', fontFamily: localStorage.getItem('zell_last_font') || '思源宋体', fontWeight: 'normal', lineHeight: 1.5, letterSpacing: 0 } },
